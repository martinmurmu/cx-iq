...
describe "/wom_requests/new.html.erb" do
  include WomRequestsHelper

  before(:each) do
    assigns[:wom_request] = stub_model(WomRequest,
      :new_record? => true,
      :user_id => 1,
...
#  it "renders new wom_request form" do
#    render
#
#    response.should have_tag("form[action=?][method=post]", wom_requests_path) do
